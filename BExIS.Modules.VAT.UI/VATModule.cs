using BExIS.Modules.VAT.UI.Helpers;
using System;
using Vaiona.Logging;
using Vaiona.Web.Mvc.Modularity;

namespace BExIS.Modules.VAT.UI
{
    public class VATModule : ModuleBase
    {
        public VATModule() : base("VAT")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of VAT...");
        }
        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of VAT...");
            try
            {
                base.Install();
                using (VATSeedDataGenerator generator = new VATSeedDataGenerator())
                {
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of VAT...");
